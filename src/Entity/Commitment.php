...
class Commitment
{
    ...
    public function getTimeToPay(): ?int
    {
        return $this->timeToPay;
    }

    public function setTimeToPay(int $timeToPay): static
    {
